    ...
    <div className="bg-gray-900 rounded-xl p-6 border border-gray-700 h-full flex flex-col">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="text-center">
          <div className="text-2xl font-bold text-blue-400">{yaw.toFixed(1)}°</div>
          <div className="text-sm text-gray-400">YAW</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-green-400">{pitch.toFixed(1)}°</div>
          <div className="text-sm text-gray-400">PITCH</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-purple-400">{roll.toFixed(1)}°</div>
